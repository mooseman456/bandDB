      ...
      <?         
         ...
         if(isset($_GET['name'])){
            ...
            for($x = 0; $x < $i; $x++)
            {
               ...
               echo("{\"name\": \"".$getMembers['name']."\",
                      \"birthDate\": \"".$getMembers['birthDate']."\",
                      \"deathDate\": \"".$getMembers['deathDate']."\",
                      \"city\": \"".$getMembers['city']."\",
                      \"state\": \"".$getMembers['state']."\",
                      \"country\": \"".$getMembers['country']."\"}");
               if ($x+1 != $i)
                  echo(", <br/><br/>");
               else
                  echo("<br/><br/>");   
